globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-FVkcW5Zq.js","assets/layout-segment-context-BajoowNE.js"];
...
function getDraftSecret() {
	return "257e67da-daf7-47c7-8e9d-d5bb8aee78ef";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "973e2cc4-a2ef-4104-8724-b37f1b81a8b3";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "973e2cc4-a2ef-4104-8724-b37f1b81a8b3") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "973e2cc4-a2ef-4104-8724-b37f1b81a8b3",
		rootBoundaryId
	});
}
/**
...
var metadata = {
	metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL ?? "https://sigvits-puerto-cortes.ale-xavala1980.chatgpt.site"),
	title: "SIGVITS | Sistema de Gestión y Vigilancia ITS",
	description: "Prototipo institucional para la vigilancia y gestión de reportes ITS en Honduras.",
	icons: {
		icon: "/favicon.svg",
	...
	openGraph: {
		title: "SIGVITS | Sistema de Gestión y Vigilancia ITS",
		description: "Plataforma institucional de vigilancia y gestión de reportes ITS para Puerto Cortés, Honduras.",
		images: [{
			url: "/og.png",
			width: 1536,
			height: 1024,
			alt: "SIGVITS — Sistema de Gestión y Vigilancia ITS"
		}]
	},
	twitter: {
