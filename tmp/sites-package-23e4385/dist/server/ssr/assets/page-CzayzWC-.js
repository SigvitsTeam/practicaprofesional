...
function MapView({ act }) {
	const [level, setLevel] = (0, import_react.useState)("municipio");
	const [metric, setMetric] = (0, import_react.useState)("Total ITS");
	const [disease, setDisease] = (0, import_react.useState)("Todas las enfermedades");
	const [sexFilter, setSexFilter] = (0, import_react.useState)("Todos");
	const [caseFilter, setCaseFilter] = (0, import_react.useState)("Nuevos y controles");
	const positions = [
		["42%", "53%"],
		["58%", "47%"],
		["28%", "35%"],
	...
	function markerValue(report) {
		let value = metric === "Casos nuevos" ? report.newCases : metric === "Controles" ? report.controls : metric === "Comunidades reportadas" ? report.outside : report.total;
		if (metric === "Total ITS") {
			if (caseFilter === "Nuevos") value = report.newCases;
			if (caseFilter === "Controles") value = report.controls;
		}
		if (disease !== "Todas las enfermedades") value *= disease === "Vaginitis" ? .34 : .19;
		if (sexFilter !== "Todos") value *= sexFilter === "Mujer" ? .62 : .38;
		return Math.max(value > 0 ? 1 : 0, Math.round(value));
	}
	const mappedReports = reports.map((report, index) => ({
		report,
		value: markerValue(report),
		position: positions[index]
	}));
	const totalVisible = mappedReports.reduce((sum, item) => sum + item.value, 0);
	function resetFilters() {
		setMetric("Total ITS");
		setDisease("Todas las enfermedades");
		setSexFilter("Todos");
		setCaseFilter("Nuevos y controles");
		act("Filtros restablecidos.");
	}
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: [
			...
			[
				"Nivel territorial",
				level === "region" ? "Región" : "Municipio",
				"amber"
			],
			[
				"Establecimientos",
				level === "region" ? "Acercar" : "6 visibles",
				"red"
			]
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, {
						title: "Indicador y filtros",
						description: "El KPI de cada marcador responde a esta selección."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "filter-field first-filter",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Indicador del marcador" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
							value: metric,
							onChange: (event) => setMetric(event.target.value),
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Total ITS" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Casos nuevos" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Controles" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Comunidades reportadas" })
							]
						})]
					}),
					...
					].map((layer) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "layer-row",
						children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Enfermedad" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
							value: disease,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "filter-field",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Sexo" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
							value: sexFilter,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "filter-field",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Tipo de caso" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
							value: caseFilter,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				...
				children: [
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: "Región Cortés"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "›" }),
								level === "municipio" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Puerto Cortés" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("small", { children: [metric, " · Julio 2026"] })
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							"aria-label": "Acercar a Puerto Cortés",
							onClick: () => setLevel("municipio"),
							children: "＋"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							"aria-label": "Alejar a Región Cortés",
							onClick: () => setLevel("region"),
							children: "−"
						})] })]
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: level === "region" ? "land-shape region-shape" : "land-shape" }),
					...
					level === "municipio" ? mappedReports.map(({ report, value, position }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						className: "map-marker",
						style: {
							left: position[0],
							top: position[1]
						},
						title: `${report.name}: ${value} · ${metric}`,
						"aria-label": `${report.name}: ${value} ${metric}`,
						onClick: () => act(`${report.name}: ${value} · ${metric}.`),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: value }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: report.name })]
					}, report.code)) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						className: "map-marker municipality-marker",
						style: {
							left: "51%",
							top: "54%"
						},
						onClick: () => setLevel("municipio"),
						"aria-label": `Acercar a Puerto Cortés: ${totalVisible} ${metric}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: totalVisible }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: "Puerto Cortés · acercar" })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, {
					title: level === "region" ? "Municipios" : "Establecimientos",
					description: `Ranking por ${metric.toLowerCase()}.`
				}), level === "region" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					onClick: () => setLevel("municipio"),
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { children: "1" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Puerto Cortés" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "6 establecimientos visibles al acercar" })] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: totalVisible })
					]
				}) : [...mappedReports].sort((a, b) => b.value - a.value).slice(0, 5).map(({ report, value }, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					onClick: () => act(`${report.name}: ${value} · ${metric}.`),
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { children: index + 1 }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: report.name }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: metric })] }),
