globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-D-o61Kuh.js","assets/layout-segment-context-ClgBLbXs.js"];
...
function getDraftSecret() {
	return "cf1bfedb-a82a-4f38-a8d6-df1b40d86fba";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "4b715d8b-728a-46d5-89fc-8a05a1c3d8f5";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "4b715d8b-728a-46d5-89fc-8a05a1c3d8f5") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "4b715d8b-728a-46d5-89fc-8a05a1c3d8f5",
		rootBoundaryId
	});
}
/**
