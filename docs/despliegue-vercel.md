...
| `SIGVITS_MAP_ATTRIBUTION`  | Crédito visible; obligatorio cuando se configura otro proveedor cartográfico              |
| `SIGVITS_MAP_MAX_ZOOM`     | Opcional; entero entre 5 y 22                                                             |
...
- Abrir Mapas y comprobar que desaparece “Cargando cartografía”, se ven las teselas y permanece
  visible la atribución. OpenStreetMap requiere su URL canónica y un `Referer` válido según su
