...
export const SCREEN_META: Record<string, ScreenMeta> = {
  Inicio: {
    ...
    description: 'Seguimiento del período, cobertura y calidad de los reportes ITS.',
  },
  'Captura ITS 1': {
    eyebrow: 'DIGITACIÓN DE COORDINACIÓN · PUERTO CORTÉS',
    title: 'Captura de atención ITS 1',
    description: 'Registro para el establecimiento seleccionado por el digitador de coordinación.',
  },
  'Reporte ITS 2': {
    eyebrow: 'DIGITACIÓN DE COORDINACIÓN · PUERTO CORTÉS',
    title: 'Reporte mensual ITS 2',
    description: 'Consolidado del establecimiento activo, preparado para revisión de coordinación.',
  },
  'Bandeja de revisión': {
    eyebrow: 'COORDINACIÓN MUNICIPAL · PUERTO CORTÉS',
    title: 'Bandeja de revisión',
    description: 'Revisión de reportes ITS 2 agregados por establecimiento.',
  },
  Consolidados: {
    eyebrow: 'COORDINACIÓN MUNICIPAL · PUERTO CORTÉS',
    title: 'Consolidado municipal',
    description: 'Seguimiento del flujo de aprobación y consolidación institucional.',
  },
  Mapas: {
    eyebrow: 'ANÁLISIS TERRITORIAL · PUERTO CORTÉS',
    title: 'Mapa operativo ITS',
    description: 'Producción y procedencias registradas por establecimiento.',
  },
  ...
  Redes: {
    ...
    description: 'Consolidación, filtros y administración de municipios asociados.',
  },
  Administración: {
    eyebrow: 'CONFIGURACIÓN · TERRITORIO',
    title: 'Administración territorial',
    description: 'Estructura sanitaria, cobertura y preparación operativa del piloto.',
  },
};

const withDemoPeriod = (reports: Report[]): Report[] =>
  reports.map((report) => ({
    ...report,
    periodYear: 2026,
    periodMonth: 7,
...
export const REPORTS: Report[] = withDemoPeriod([
  {
...
export const MUNICIPAL_REPORTS: Report[] = withDemoPeriod([
  {
    name: 'Puerto Cortés',
    code: '0506',
    status: 'En revisión',
...
export const REGIONAL_REPORTS: Report[] = withDemoPeriod([
  {
  ...
  {
    name: 'Región Sanitaria de Atlántida',
    code: '01',
    status: 'Pendiente',
    total: 0,
    newCases: 0,
  ...
  {
    name: 'Región Sanitaria de Francisco Morazán',
    code: '08',
    status: 'Pendiente',
    total: 0,
    newCases: 0,
  ...
  {
    name: 'Región Sanitaria de Colón',
    code: '02',
    status: 'Pendiente',
    total: 0,
    newCases: 0,
